...
//        ElectricFleetUtils.setChargerTypes(carVehicleType, Arrays.asList("a", "b", "default" ) );
        ...
        scenario.getPopulation().getPersons().values().stream()
                ...
                .forEach(person -> {
                    ...
                    ElectricFleetUtils.setInitialSoc(newVehicle, 0.7); //TODO think about a better way to set the initial SoC
                    ...
                    //debugging
                        ...
                        for (Leg leg : TripStructureUtils.getLegs(person.getSelectedPlan())) {
                            if (leg.getTravelTime().isUndefined()){
                                System.out.println("undefined travel time for agent " + person.getId() + " at depTime" + leg.getDepartureTime() + " with mode " + leg.getMode());
                            }
